  ...
  return (
    ...
    {loading ? (
      <div className="flex justify-center items-center min-h-[400px]">
        <p className="leading-7 [&:not(:first-child)]:mt-6">Cargando animales...</p>
      </div>
      ) : animals.length === 0 ? (
      <div className="flex justify-center items-center min-h-[400px]">
        <p className="leading-7 [&:not(:first-child)]:mt-6">No hay animales disponibles :(</p>
      </div>
      ) : (
      <div className="mx-auto max-w-6xl py-8">
      <div className="mb-8">
        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight text-balance">Catalogo de animales</h1>
